...
function createCard(cardItem) {
    ...
    // assign class attribute to image element of back card
    addClassToElement(cardBackImg, 'card-img');

    // assign class attribute to front image element of front card
    ...
    // add card element as child element to appropriate grid
