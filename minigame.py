...
as their second and 3rd letter. You get four guesses.\n''')
...
def getWords():
    ...
    To make the game fair, we to to ensure that there are words with
    a range of matching numbers of letters as the secret word."""
    secretPassword = random.choice(WORDS)
    words = [secretPassword]
    
    # Find two or more words; these have zero matching letters.
